    ...
    <div className="CommPostDetail">
      ...
      <div>
        ...
        <ul>
          ...
          <div className="collapsible__content">
            <p>
              No one told me that I needed to mentally prepare for my nipples to
          ...
          <div className="collapsible__content">
            <p>
              Is it ok to start giving my 2 weeks old baby milk and cereal? He
          ...
          <div className="collapsible__content">
            <p>
              I just got these Lactation cookies from Baby&Co, and I love it!
          ...
          <div className="collapsible__content">
            <p>
              The breastmilk I pumped looks pink. Could it be blood? Has any one
